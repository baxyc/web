<?php 
$name = 'Иван Иванов';
$profession = 'Директор производства';
$city = 'Южно-Сахалинск';
$email = 'baxyc.da@gmail.com';
$tel = 89242891616;
 
$skills = [
	['name' => 'Руководство', 'percent' => 97],
	['name' => 'Способность расставлять приоритеты', 'percent' => 80],
	['name' => 'Умение объяснять', 'percent' => 90],
 ...
 $works = [
    ...
    "description"=> "Контроль работы произвоства, постановка задач и целий, выполнение планов.  ",
 ],
 ["name" => "Управляющий комплексом",
 "dataStart" =>"Май 2015",
 "dataEnd" => "Январь 2019",
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="https://catherineasquithgallery.com/uploads/posts/2021-03/1614610387_167-p-zadnii-fon-dlya-fotoshopa-238.jpg" style="width:100%" alt="Avatar">
